...
const NasiGoreng = ({ props }) => {
    ...
    return (
        <div className={`lg:max-w-[290px] lg:w-[450px] min-h-[500px]  bg-gradient-radial from-white to-orange-200 shadow-md rounded-xl duration-1000 cursor-pointer hover:scale-105 hover:shadow-xl relative max-md:w-full `} onMouseOver={() => setHover(true)} onMouseLeave={() => setHover(false)}>
